...
blinky_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/red.png'), (32, 32))
pinky_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/pink.png'), (32, 32))
inky_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/blue.png'), (32, 32))
clyde_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/orange.png'), (32, 32))
spooked_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/powerup.png'), (32, 32))
dead_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/dead.png'), (32, 32))
...
def check_position(centerx, centery):
    ...
    num1 = (HEIGHT - 50) // 32  # Adjusted for the new screen height
    num2 = (WIDTH // 30)  # Adjusted for the new screen width
    num3 = 15  # No changes needed

    # Check collisions based on center x and center y of player +/- fudge number
    if centerx // 30 < 20:  # Adjusted for the new screen width
        if direction == 0 and centerx >= num3 // num2:
            if level[centery // num1][(centerx - num3) // num2] < 3:
                turns[1] = True
        if direction == 1 and centerx <= (WIDTH - num3) // num2:
            if level[centery // num1][(centerx + num3) // num2] < 3:
                turns[0] = True
        if direction == 2 and centery <= (HEIGHT - num3) // num1:
            if level[(centery + num3) // num1][centerx // num2] < 3:
                turns[3] = True
        if direction == 3 and centery >= num3 // num1:
            if level[(centery - num3) // num1][centerx // num2] < 3:
                turns[2] = True

        if direction == 2 or direction == 3:
            if 12 <= centerx % num2 <= 18:
                if (centery + num3) // num1 < len(level) and level[(centery + num3) // num1][centerx // num2] < 3:
                    turns[3] = True
            ...
            if 12 <= centery % num1 <= 18:
                if (centerx - num2) // num2 >= 0 and level[centery // num1][(centerx - num2) // num2] < 3:
                    turns[1] = True
                if (centerx + num2) // num2 < len(level[0]) and level[centery // num1][(centerx + num2) // num2] < 3:
                    turns[0] = True
        if direction == 0 or direction == 1:
            if 12 <= centerx % num2 <= 18:
                if (centery + num1) // num1 < len(level) and level[(centery + num1) // num1][centerx // num2] < 3:
                    turns[3] = True
            ...
            if 12 <= centery % num1 <= 18:
                if (centerx - num3) // num2 >= 0 and level[centery // num1][(centerx - num3) // num2] < 3:
                    turns[1] = True
                if (centerx + num3) // num2 < len(level[0]) and level[centery // num1][(centerx + num3) // num2] < 3:
                    turns[0] = True
    else:
        turns[0] = True
        turns[1] = True
